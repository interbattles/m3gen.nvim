...
local custom_highlight_group = require('m3gen').get('custom_highlight_group') or false
local custom_highlight_groups = require('m3gen').get('custom_highlight_groups') or {}
